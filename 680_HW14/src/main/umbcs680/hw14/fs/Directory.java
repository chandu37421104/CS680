...
public class Directory extends FSElement {
    ...
    public List<Directory> getSubDirectories() {
        return getSubDirectories(Comparator.comparing(Directory::getName)); // Default to sorting by name
    }
    ...
    public List<File> getFiles() {
        return getFiles(Comparator.comparing(File::getName)); // Default to sorting by name
    }
